<div class="w-full flex flex-col justify-center items-center text-center">
    <span class="lg:text-3xl md:text-2xl text-xl font-bold text-gray-700">Recover password</span>
    <span class="font-medium text-gray-400 mt-2">Choose a new password to your account and click submit button to confirm</span>
