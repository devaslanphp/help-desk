<div class="w-full flex flex-col justify-start items-start gap-5">
            ...
            <div class="w-full flex flex-row justify-start items-start flex-wrap -ml-2">
                @foreach(auth()->user()->favoriteProjects as $project)
                    <div class="xl:w-1/5 lg:w-1/4 md:w-1/3 sm:w-1/2 w-full p-2">
                        <div
                            class="w-full flex flex-col gap-1 p-5 border border-gray-100 rounded-lg
                            shadow bg-white hover:shadow-lg">
                            ...
                            <span class="text-warning-500 font-medium text-xs flex flex-row items-center gap-1">
                                ...
                                @lang($project->tickets()->count() > 1 ? 'Tickets' : 'Ticket')
                            </span>
                            <a href="{{ route('tickets', ['project' => $project->id]) }}"
                               class="mt-2 text-primary-500 hover:text-primary-600 font-normal text-sm hover:underline">
                                @lang('View tickets')
                            </a>
                        </div>
                    </div>
    ...
    <div class="w-full mt-5">
        <div class="w-full flex flex-col justify-start items-start gap-5">
            ...
            <div id="projectModal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative p-4 w-full max-w-4xl h-full md:h-auto">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                            ...
                            <button wire:click="cancelProject()" type="button"
