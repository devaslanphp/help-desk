    ...
    <div class="w-full flex md:flex-row flex-col justify-between items-start gap-2">
        <div class="flex flex-col justify-center items-start gap-1">
                <span class="lg:text-4xl md:text-2xl text-xl font-medium text-gray-700 flex items-center gap-3">
                    @lang('Tickets')
                    <div wire:loading>
                        <i class="fa fa-spin fa-spinner opacity-50"></i>
                    </div>
                </span>
        ...
        @if(has_all_permissions(auth()->user(), 'create-tickets'))
            <button type="button" wire:click="createTicket()" class="bg-primary-700 text-white hover:bg-primary-800 px-4 py-2 rounded-lg shadow hover:shadow-lg text-base">
            ...
            <div class="w-full flex flex-col gap-5" wire:ignore>
                <div id="filter-accordion" data-accordion="collapse">
                    <h2 id="filter-accordion-heading">
                        <button type="button" class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-gray-200 rounded-t-lg focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800" data-accordion-target="#filter-accordion-body" aria-expanded="false" aria-controls="filter-accordion-body">
        ...
        @if($tickets->count())
            <div class="w-full flex flex-col justify-start items-start gap-5">
                @foreach($tickets as $ticket)
                    <div class="w-full bg-white border border-gray-200 shadow hover:shadow-lg rounded-lg p-5 flex flex-col justify-start items-start gap-1">
                            ...
                            @if($ticket->responsible)
                                <div class="flex flex-row justify-start items-center gap-2">
                                    ...
                                    <div class="flex flex-col gap-0">
                                        ...
                                        <span class="font-light text-gray-500 text-base">{{ $ticket->responsible->name }}</span>
                                    </div>
                                </div>
                            @endif
                        </div>
        ...
        <div class="relative p-4 w-full max-w-4xl h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                    ...
                    <button wire:click="cancelTicket()" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
